...
import { X, MapPin, Search, Phone, Droplet, UserCircle, Bell, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md max-h-[90vh] bg-[#fffafa] rounded-3xl shadow-2xl overflow-hidden flex flex-col"
      >
        {/* Header */}
        <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-xl border-b border-red-50 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
             <div className="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center">
                <Droplet className="w-5 h-5 text-red-600" />
             </div>
             <h2 className="text-xl font-bold text-gray-800">ব্যবহার নির্দেশিকা</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto p-6 space-y-6">
          ...
          <div className="text-center mb-8">
            <div className="mx-auto mb-4 flex justify-center">
              <img src="/logo.png" className="h-28 w-auto object-contain mix-blend-multiply" alt="ReDrop Logo" />
            </div>
            <h3 className="text-xl font-black text-gray-900 mb-2 tracking-tight">ReDrop App</h3>
            <p className="text-xs text-gray-500 leading-relaxed px-4 text-balance">
          ...
          <div className="space-y-4">
            {/* Step 1 */}
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-red-50">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center shrink-0">
                  <UserCircle className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="font-bold text-gray-900 mb-1 text-sm">১. প্রোফাইল সম্পূর্ণ করা</h4>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-red-50">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-1 text-sm">৩. নির্দিষ্ট গ্রুপের রক্তদাতা খোঁজা</h4>
                  <p className="text-[11px] text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-red-50">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-1 text-sm">৪. ম্যাপ ও রিয়েল-টাইম দূরত্ব</h4>
                  <p className="text-[11px] text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-red-50">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-1 text-sm">৫. ডোনারের সাথে যোগাযোগ</h4>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-red-50">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-1 text-sm">৬. নিজের জন্য রিকোয়েস্ট (Urgent)</h4>
                  <p className="text-[11px] text-gray-600 leading-relaxed">
          ...
          <button
            onClick={onClose}
            className="w-full py-4 bg-gray-900 text-white rounded-2xl font-bold text-sm shadow-xl active:scale-95 transition-all mt-4"
          >
            বুঝেছি
          </button>
        </div>
