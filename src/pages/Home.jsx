...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fffafa] text-red-950 pb-20 font-sans selection:bg-red-200 selection:text-red-900 transition-colors duration-300">
      ...
      <header className="bg-white/80 backdrop-blur-xl shadow-sm shadow-red-100/50 border-b border-red-50 sticky top-0 z-20">
        <div className="max-w-md mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-1 items-center">
            <button 
              onClick={() => setIsProfileOpen(true)} className="relative p-2 text-gray-500 hover:text-red-500 transition-colors rounded-full hover:bg-gray-100 :bg-gray-800"
              aria-label="Profile"
            >
            ...
            <button 
              onClick={handleLogout} className="p-2 text-gray-500 hover:text-red-500 transition-colors rounded-full hover:bg-gray-100 :bg-gray-800"
              aria-label="Logout"
            >
      ...
      <main className="max-w-md mx-auto px-4 py-6 space-y-8">
                      ...
                      <div className="mt-2 pt-2 border-t border-gray-200 flex justify-between items-center">
                          {currentUser?.uid === feed.postedBy ? (
                             <button
                                ...
                                }} className="text-xs font-bold text-gray-500 hover:text-red-600 :text-red-400 transition-colors"
                             >
                                Delete
                             </button>
                          ) : (<span></span>)}
                          <a href={`tel:${feed.phone}`} className="text-xs font-bold text-red-600 bg-red-50 hover:bg-red-100 :bg-red-900/40 px-3 py-1 rounded-md transition-colors flex items-center gap-1">
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl p-6 shadow-sm shadow-red-100/50 border border-red-100 space-y-4 relative z-0 transition-colors">
          ...
          <div className="relative">
            ...
            <input 
              type="text" 
              placeholder="Search locations in Bangladesh..." className="w-full bg-gray-50 pl-10 pr-4 py-3 rounded-xl border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-red-500 outline-none text-sm transition-all text-gray-700"
            />
          </div>
          ...
          <div className="space-y-3 pt-2 min-h-[200px]">
            {!isProfileComplete ? (
              <div className="text-center py-10 bg-white/50 backdrop-blur-md rounded-2xl border border-red-100 shadow-sm shadow-red-100/50 animate-in fade-in duration-300">
              ...
              displayedDonors.map((donor) => (
                <div key={donor.id} className="flex flex-col p-4 rounded-2xl bg-gray-50 hover:bg-red-50 :bg-red-900/10 transition-all cursor-pointer group border border-transparent hover:border-red-100 :border-red-900/30">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-white shadow-sm flex items-center justify-center font-bold text-red-600 ring-1 ring-gray-100 group-hover:ring-red-200 :ring-red-500/30">
                        {donor.group}
                      </div>
                      <div>
      ...
      {/* Footer */}
      <footer className="max-w-md mx-auto px-4 py-6 mb-4 text-center text-sm text-gray-500">
        Created By: <a href="https://www.linkedin.com/in/sma-rashik/" target="_blank" rel="noopener noreferrer" className="font-semibold text-red-600 hover:text-red-700 :text-red-300 hover:underline transition-colors">S M Abdul Rashik</a>
      </footer>
